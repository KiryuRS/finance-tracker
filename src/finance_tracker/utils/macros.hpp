...
#define ENUM_REFLECTION(enum_namespace, enum_name, ...) \
    ...
    { \
        ...
        static inline constexpr std::array<enum_namespace::enum_name, size> enum_array = { \
            BOOST_PP_SEQ_FOR_EACH(ENUM_IDENTITY_NAMESPACE, enum_namespace::enum_name, BOOST_PP_VARIADIC_TO_SEQ(__VA_ARGS__)) \
        }; \
